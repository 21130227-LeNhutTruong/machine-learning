...
public class Node {
	...
	public double getEdgeCost(Node fromNode, Node toNode) {
	    for (Edge edge : fromNode.getChildren()) {
	        if (edge.getEnd() == toNode) {
	            return edge.getWeight();
	        }
	    }
	    return Double.POSITIVE_INFINITY; // Trả về dương vô cùng nếu không tìm thấy cạnh.
	}
}
